...
export const sectionData = {
  cfp: {
    chatBubble: {
      ...
      answer: "We welcome 2-page papers, pictorials, or 2-minute videos exploring how genUI will enable new human-centric experiences and how HCI practice must evolve. Submissions should address methods, roles, workflows, education, or technical stacks."
    },
    sidebar: {
      title: "Call for Participation",
      summary: "We invite researchers, designers, and practitioners to explore how generative UI—interfaces created by AI models—will reshape design methods, workflows, and user experiences. Our goals are to (i) envision how genUI can underpin innovative human-centric experiences, and (ii) reflect on how HCI and design practice could and should evolve to meet the opportunities and challenges this presents.",
      sections: [
        {
    ...
    chatBubbles: [
      {
        ...
        answer: "This interactive workshop features two 90-minute sessions with a pop-up panel, creative ideation exercises, and collaborative artefact development exploring the future of generative UI in HCI practice. We'll dive deep into how generative interfaces can reshape design methods and workflows."
      },
      {
        fullQuestion: "How will the sessions be structured?",
        answer: "Session 1 features a human spectrogram activity, a pop-up panel with industry and academic experts, and Crazy 8s sketching exercises. Session 2 focuses on small-group artefact creation, where you'll develop concrete guides, frameworks, or visions for genUI and HCI practice."
      },
      {
        fullQuestion: "What will I create at the workshop?",
        answer: "You'll contribute to concrete artefacts like guides for using genUI in HCI practice, maps of new workflows and roles, design principles for ephemeral interfaces, visions of technical stacks, or educational materials for the next generation of HCI practitioners."
      }
    ],
    sidebar: {
      title: "Program",
      summary: "The workshop runs over two 90-minute sessions and is highly interactive. We combine a human spectrogram, a pop-up panel, and fast sketching in Session 1, with small-group artefact creation in Session 2. The goal is to move from shared understanding to concrete guides, frameworks, and visions for genUI and HCI practice.",
      sections: [
        {
  ...
  organizers: {
    ...
    sidebar: {
      title: "Organizers",
      summary: "The workshop is organized by a multidisciplinary team from industry and academia, with expertise in dynamic and generative UI, HCI and design practice, and human–AI interaction.",
      sections: [
        {
